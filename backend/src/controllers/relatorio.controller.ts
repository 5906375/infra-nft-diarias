...
import Imovel from "../models/imovel.model.js";
import mongoose from "mongoose";

// 📆 Reservas por dia
export const getReservasPorDia = async (req: Request, res: Response) => {
    try {
...
// 📅 Reservas por mês
export const getReservasPorMes = async (req: Request, res: Response) => {
    try {
        const resultados = await RelatorioModel.aggregate([
...
// 💰 Receita por imóvel
export const getReceitaPorImovel = async (req: Request, res: Response) => {
    try {
...
export const getReceitaPorDia = async (req: Request, res: Response) => {
    try {
        const resultados = await Pagamento.aggregate([
            {
                $group: {
