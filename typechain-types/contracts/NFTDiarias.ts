...
export interface NFTDiariasInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface NFTDiarias extends BaseContract {
  connect(runner?: ContractRunner | null): NFTDiarias;
  waitForDeployment(): Promise<this>;

  interface: NFTDiariasInterface;
